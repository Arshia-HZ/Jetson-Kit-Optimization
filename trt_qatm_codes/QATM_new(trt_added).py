...
class Featex2():
    def __init__(self, model1, model2, use_cuda):
        ...
        self.input_shape_2 = TARGET_SHAPE ### >>> this line should be equal to original picture shape (please change this based on input shape) i.e. (1, 3, 225, 384)
    ...
    def __call__(self, target, mode='big'):
        ...
        print("feature1 shape: ", self.feature1.shape)
        print("feature2 shape: ", self.feature2.shape)
...
print("Inf time in seconds: ", end - start)
